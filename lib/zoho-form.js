...
export const ZOHO_CONFIG = {
  ...
  returnUrl:  `${SITE_URL}/zoho-thanks.html`,

  // Must match a Lead Source picklist value in Zoho EXACTLY. Zoho silently
  // drops a submitted value that is not a configured option — the lead still
  // arrives, unattributed, with nothing surfacing the failure. Add the
  // picklist value in Zoho BEFORE changing this string.
  leadSource: 'Atropos - Contact Form',
}
