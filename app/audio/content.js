...
export const HERO = {
  ...
  body:  'Music that follows you through your home — from the kitchen to the pool deck. Multi-zone, multi-source, and brilliantly clear.',
}

export const INTRO = {
  label: 'What We Do',
  title: 'The right music. Every room. Always.',
  body:  'Distributed audio is the most-used system in any smart home. It is the one that runs every morning, every evening, every dinner party and lazy Sunday. We design whole-home audio systems that are musically capable, architecturally invisible, and genuinely simple to use — whether you are streaming Spotify, playing a record, or routing different sources to different rooms simultaneously.',
}
...
export const FEATURES = [
  {
    ...
    desc:   'Spotify, Apple Music, Tidal, and internet radio — streamed to any room, in any combination, from any device. Bluesound and Sonos ecosystems supported.',
  },
  {
    number: '02',
    title:  'Multi-zone Control',
    desc:   'Independent volume and source control per zone. The kitchen plays jazz while the master suite has something quieter. All from a single app or in-wall panel.',
  },
  {
    number: '03',
    title:  'High-fidelity Performance',
    desc:   'In-ceiling and in-wall speakers from Sonance, KEF, and Bowers & Wilkins — selected for their acoustic performance, not just their appearance in the ceiling.',
  },
  {
    number: '04',
    title:  'Outdoor Audio',
    desc:   'Weatherproof landscape and in-ceiling speakers for alfresco areas, pool decks, and gardens. Outdoor audio specified for the acoustic challenges of open space.',
  },
  {
    number: '05',
    title:  'High-resolution Sources',
    desc:   'Network audio players, turntable integration, and hi-res streaming for the audiophile zones of your home — without compromising the simplicity of the rest.',
  },
  {
    number: '06',
    title:  'Automation Integration',
    desc:   'Audio as part of your scenes. "Good Morning" fades up your playlist. "Goodnight" fades it off. Music integrated with the rest of your smart home seamlessly.',
  },
]
