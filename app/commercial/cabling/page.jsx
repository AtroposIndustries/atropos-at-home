...
export const metadata = {
  ...
  keywords: [
    ...
    'comms room design Tasmania',
    'Cat6A cabling commercial',
    'data cabling contractor Hobart',
...
export default function CablingPage() {
  return (
    <>
      ...
      <CtaBand
        title={<>Ready for cabling built right<br />from first <em>fix?</em></>}
        body="Tell us about your build stage and floor plan. We will scope the pathways."
