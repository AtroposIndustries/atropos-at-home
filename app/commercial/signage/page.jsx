...
export const metadata = {
  ...
  keywords: [
    'digital signage Hobart',
    'commercial signage Tasmania',
    'wayfinding signage installer',
    'digital menu boards Hobart',
    'signage content management Tasmania',
...
export default function SignagePage() {
  return (
    <>
      ...
      <CtaBand
        title={<>Ready for screens built<br />for the whole <em>day?</em></>}
        body="Tell us about your site and how many screens you're running. We will scope the platform."
