...
export const metadata = {
  ...
  keywords: [
    ...
    'Zoom Rooms installer Tasmania',
    'Microsoft Teams Rooms Hobart',
    'conference room camera microphone',
    'room booking panel Tasmania',
...
export default function MeetingRoomsPage() {
  return (
    <>
      ...
      <CtaBand
        title={<>Ready for a room<br />that just <em>works?</em></>}
        body="Tell us about your room and the platform your business runs. We will design the coverage."
